...
from control_plane.control.periodic.projects import ProjectsLifecycleActions
...
class LifecycleActions:
    def __init__(self, data_store: DataStore, provisioner: AbstractProvisioner) -> None:
        self._projects = ProjectsLifecycleActions(data_store)
