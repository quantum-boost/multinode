...
class Multinode:
    def __init__(self) -> None:
        self.functions: Dict[str, Function[Any, Any]] = {}
    ...
    def function(
    ...
    ) -> Callable[[Callable[[InputT], OutputT]], Function[InputT, OutputT]]:
        """
        ...
        def decorator(fn: Callable[[InputT], OutputT]) -> Function[InputT, OutputT]:
            ...
            function_obj: Function[InputT, OutputT] = Function(fn_spec)

            self.functions[fn.__name__] = function_obj
            return function_obj
